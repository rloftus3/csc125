...
int main()
{
  ...
  cout  robot.getPostData(); /// reads the form and inits the object
  cout  << "On Saturday, stakes were high, circuits "
  << robot.getField("gerund")
  << ", with a rather “electric” excitement in the air. The Siebel Center at the University ofIllinois hosted various Midwest colleges for the second annual "
